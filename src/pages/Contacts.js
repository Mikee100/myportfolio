...
const Contacts  = () =>  {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_a911eb5', 'template_ye9c297', e.target, 'KeePPXIGkpTcoiTBJ')
      .then((result) => {
...
<div className='footer'>
  ...
  <ul className='ul_pages'>
    <p>Pages</p>
    <li className='li_pages' onClick={handleClickScroll} > Home </li>
    <li className='li_pages' onClick={handleClickScroll2}> About </li>
    <li className='li_pages' onClick={handleClickScroll3}> Experience </li>
    <li className='li_pages' onClick={handleClickScroll5}> Skills </li>
    <li className='li_pages' onClick={handleClickScroll4}> Projects </li>
  </ul>
  

  <ul className='media_icons'>
<p>Socials</p>
    <li> <a  target='blank' href='https://github.com/Mikee100/utilitybank'> <FaInstagram className='faicon' /></a></li>
    <li> <a  target='blank' href='https://github.com/Mikee100/utilitybank'><FaGithub  className='faicon' /></a></li>  
    <li> <a  target='blank' href='https://github.com/Mikee100/utilitybank'> <FaLinkedin   className='faicon'/></a> </li>
